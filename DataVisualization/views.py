...
def data(request):
    ...
    labels = ['crying', 'sad', 'angry', 'disappointed', 'unhappy',
              'neutral', 'happy', 'very_happy', 'joyful', 'excited', 'ecstatic']
    values = [crying, sad, angry, disappointed, unhappy,
              neutral, happy, very_happy, joyful, excited, ecstatic]
    ...
    for program in all_programs:
        ...
        previous_data = PreviousMonth.objects.all()
        dic_previous_data = {
